				  		...
				  		<form class="layui-form" style="margin:5% auto;padding:30px;width: 500px;">
				  			<div class="layui-form-item">
							    ...
							    <div class="layui-input-block">
							        <input type="text" name="good_name" placeholder="请输入商品名称" lay-verify="required|good_name" required class="layui-input">
							    </div>
							</div>
							<div class="layui-form-item">
							    <label class="layui-form-label">商品价格</label>
							    <div class="layui-input-block">
							        <input type="text" name="price" placeholder="请输入商品价格，最多保留两位小数" lay-verify="required|price" required class="layui-input">
							    </div>
							</div>
							<div class="layui-form-item">
							    <label class="layui-form-label">商品简介</label>
							    <div class="layui-input-block">
							         <textarea name="intro" placeholder="请输入商品简介" lay-verify="intro" class="layui-textarea"></textarea>
							    </div>
							</div>
							<div class="layui-form-item">
							    <label class="layui-form-label">商品库存</label>
							    <div class="layui-input-block">
							         <input type="text" name="inventory" placeholder="请输入商品库存" lay-verify="required|number" required class="layui-input">
							    </div>
							</div>
							<div class="layui-form-item">
							    ...
							    <div class="layui-input-block">
								    ...
								    <select class="normal-select" lay-verify="required" lay-ignore name="cid" id="cid">
								        	<option value="" selected>请选择次分类</option>
								        	<?php 
								        		$p_cate = $_SQL->query("SELECT id,pid,cate_name FROM category WHERE delete_time = 0 AND pid != 0");
								        		foreach ($p_cate as $key => $value) {
								        			extract($value);
	...
	<?php 
	 ...
	 <script type="text/javascript">
		...
		function deletePhoto(obj){
			...
			//删除服务器图片
			$.ajax({
				url:'/admin/good_photo_delete.php',
				data:{path:del_path},
				dataType:'json',
		  		method:'post',
		  		success: function(ret){
